...
# Ask quetions about the image
print("How many of each gender are in the photo?")
query_start_time = time.time()
answer = model.query(encoded_image, "How many of each gender are in the photo?")["answer"]
query_done_time = time.time()
print(f"Query Time: {query_done_time - query_start_time:.2f} seconds")
print(answer)

# Ask quetions about the image
print("The name of the person in the center is Hanna.  What color is Hanna's shirt?")
query_start_time = time.time()
answer = model.query(encoded_image, "The namme of the person in the center is Hanna.  What color is Hanna's shirt?")["answer"]
query_done_time = time.time()
print(f"Query Time: {query_done_time - query_start_time:.2f} seconds")
print(answer)
