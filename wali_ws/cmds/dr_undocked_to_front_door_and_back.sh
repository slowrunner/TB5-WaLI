...
~/TB5-WaLI/utils/logMaintenance.py "Dead-Reckoning To The Front Door From Undocked (and back)"
...
~/TB5-WaLI/utils/logMaintenance.py "Arrived at front door"
...
~/TB5-WaLI/utils/logMaintenance.py "Dead-Reckoning Back To Undocked Position From The Front Door"
...
# ~/TB5-WaLI/utils/logMaintenance.py "Attempting manual docking"
...
echo -e "\n*** EXCURSION COMPLETE ***"
cmds/say.sh "Excursion complete."
~/TB5-WaLI/utils/logMaintenance.py "Excursion from undocked to front door and back complete"
