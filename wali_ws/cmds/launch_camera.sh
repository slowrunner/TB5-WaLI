...
echo -e "ros2 launch depthai_ros_driver camera.launch.py camera_model:=OAK-D-LITE params_file:=/home/ubuntu/TB5-WaLI/wali_ws/params/camera.yaml\n"
ros2 launch depthai_ros_driver camera.launch.py camera_model:=OAK-D-LITE params_file:=/home/ubuntu/TB5-WaLI/wali_ws/params/camera.yaml
