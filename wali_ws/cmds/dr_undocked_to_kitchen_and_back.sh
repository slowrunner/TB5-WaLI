...
~/TB5-WaLI/utils/logMaintenance.py "Dead-Reckoning To Kitchen From Undocked (and back)"
...
~/TB5-WaLI/utils/logMaintenance.py "Arrived at Kitchen"
...
~/TB5-WaLI/utils/logMaintenance.py "Dead-Reckoning Back To Undocked position From Kitchen"
