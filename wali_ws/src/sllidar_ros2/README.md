# SLAMTEC C1 LIDAR ROS2 For TB5-WaLI

For the time being I forced turtlebot_bringup to launch the C1 LIDAR driver:  

- git clone https://github.com/Slamtec/sllidar_ros2/tree/main
- rebuild to create install/lib/sllidar_node
- copied install/lib/sllidar_node to /opt/ros/jazzy/lib/rplidar_ros/
- modified copy of sllidar_c1_launch.py as rplidar.launch.py: 
  - frame_id: rplidar_link
  - package: rplidar_composition
  - executable: sllidar_node
  - name: rplidar_composition
- saved copy of existing /opt/ros/jazzy/share/turtlebot_bringup/launch/rplidar.launch.py
- copied rplidar.launch.py to /opt/ros/jazzy/share/turtlebot_bringup/launch
