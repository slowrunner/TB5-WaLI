...
def main():
    ...
    # goal_pose = navigator.getPoseStamped([-0.3, -0.36], TurtleBot4Directions.SOUTH)  # WaLI undocked plus 15cm
    goal_pose = navigator.getPoseStamped([-0.15, -0.32], WaLI_Dir.NORTH)    # WaLI undocked plus a little

    # Go to each goal pose
    navigator.info('Starting to undocked position')
